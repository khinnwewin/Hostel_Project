...
@section('content')
    <section class="content-header">
        ...
        <span class="breadcrumb"><a href='{{ route("mrollcall.index") }}' class="btn btn-sm btn-primary"><i
                    class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Go To Male Roll Call</a></span>
    </section>
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                {!! Form::model($rollcall, ['route' => ['mrollcall.update', $rollcall->id], 'method' => 'patch']) !!}
