...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <!-- <form method="post" action="{{ url('select/'.$register->id) }}"> -->
                    {!! Form::model($register, ['route' => ['select.update', $register->id], 'method' => 'patch']) !!}
                    {{ csrf_field() }}
                    ...
                    <div class="form-group col-sm-12">
                       ...
                       <a href="{{ url('admin/select') }}" class="btn btn-default">Cancel</a>
                    </div>
                    {!! Form::close() !!}
                <!-- </form> -->
            </div>
