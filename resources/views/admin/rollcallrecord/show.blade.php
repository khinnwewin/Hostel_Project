    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    ...
                    {!! Form::model($rollcallrecords, ['route' => ['rollcallrecord.update', $rollcallrecords->id], 'method' => 'patch']) !!}
                    {{ csrf_field() }}
                    ...
                    <div class="form-group col-sm-12">
                       ...
                       <a href="{!! route('rollcallrecord.index') !!}" class="btn btn-default">Cancel</a>
                    </div>
                    {!! Form::close() !!}
                <!-- </form> -->
            </div>
