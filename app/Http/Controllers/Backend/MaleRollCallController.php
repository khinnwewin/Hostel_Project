...
class MaleRollCallController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      //  dd($registers);
        return view('admin.mrollcall.index',compact('registers'));
    }
    ...
    public function edit($id)
    {
      ...
      //dd($rollcall);
        if(empty($rollcall)) {
            ...
            return redirect(route('mrollcall.index'));
        }
        return view('admin.mrollcall.edit', compact('rollcall'));
    }
